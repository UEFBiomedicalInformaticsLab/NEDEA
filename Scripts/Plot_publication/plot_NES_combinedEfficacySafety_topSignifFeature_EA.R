...
for(disease in c("BreastCancer", "KidneyCancer", "LungCancer", "OvaryCancer", "ProstateCancer", "SkinCancer")){
  ...
  if(!dir.exists(paste0("OutputFiles/Plots_publication/NES_", feature_type, "_boxplot_topSignifFeatures_EA/"))){
    dir.create(paste0("OutputFiles/Plots_publication/NES_", feature_type, "_boxplot_topSignifFeatures_EA/"))
  }
  
  tiff(paste0("OutputFiles/Plots_publication/NES_", feature_type, "_boxplot_topSignifFeatures_EA/NES_", feature_type, "_boxplot_topSignifFeatures_EA_", disease, ".tiff"), 
       width = 20,
       height = 7,
...
for(drug_target_type in c("known", "KEGG", "NPA", "PS", "RI", "SIGNOR","all")){
  ...
  tiff(paste0("OutputFiles/Plots_publication/NES_", feature_type, "_boxplot_topSignifFeatures_EA/NES_", feature_type, "_boxplot_topSignifFeatures_EA_", drug_target_type, ".tiff"),
       width = 20,
       height = 7,
       units = "cm", compression = "lzw", res = 1200)
  print(tmp2)
