...
# Script to plot the accuracy scores from validation 3b
...
for(disease in c("BreastCancer", "KidneyCancer", "LungCancer", "OvaryCancer", "ProstateCancer", "SkinCancer")){
  ...
  if(file.exists(paste0("OutputFiles/Validation_data_3b/Prediction_metrics/predictionMetrics_NES_combinedEfficacySafety_", disease, "_", drug_target_type, ".csv"))){
    predict_metrics[[disease]] <- read.csv(file = paste0("OutputFiles/Validation_data_3b/Prediction_metrics/predictionMetrics_NES_combinedEfficacySafety_", disease, "_", drug_target_type, ".csv"), header = TRUE)
  }
}
...
tiff(paste0("OutputFiles/Plots_publication/Validation/Validation3b_predictionMetrics_NES_combinedEfficacySafety_", drug_target_type, ".tiff"),
     width = 8,
     height = 3,
