...
for(disease in c("BreastCancer", "KidneyCancer", "LungCancer", "OvaryCancer", "ProstateCancer", "SkinCancer")){
  ...
  if(!dir.exists(paste0("OutputFiles/Plots_publication/NES_", feature_type, "_boxplot_topSignifFeatures_ADR/"))){
    dir.create(paste0("OutputFiles/Plots_publication/NES_", feature_type, "_boxplot_topSignifFeatures_ADR/"))
  }
  
  tiff(paste0("OutputFiles/Plots_publication/NES_", feature_type, "_boxplot_topSignifFeatures_ADR/NES_", feature_type, "_boxplot_topSignifFeatures_ADR_", disease, ".tiff"), 
       width = 20,
       height = 7,
