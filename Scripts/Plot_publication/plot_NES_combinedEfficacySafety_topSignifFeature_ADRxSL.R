...
for(disease in c("BreastCancer", "KidneyCancer", "LungCancer", "OvaryCancer", "ProstateCancer", "SkinCancer")){
  ...
  if(!dir.exists(paste0("OutputFiles/Plots_publication/NES_", feature_type, "_boxplot_topSignifFeatures_ADRxSL/"))){
    dir.create(paste0("OutputFiles/Plots_publication/NES_", feature_type, "_boxplot_topSignifFeatures_ADRxSL/"))
  }
  
  tiff(paste0("OutputFiles/Plots_publication/NES_", feature_type, "_boxplot_topSignifFeatures_ADRxSL/NES_", feature_type, "_boxplot_topSignifFeatures_ADRxSL_", disease, ".tiff"), 
       width = 50,
       height = 40,
