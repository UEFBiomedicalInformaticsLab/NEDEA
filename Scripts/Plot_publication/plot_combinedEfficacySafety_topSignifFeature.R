...
for(disease in c("BreastCancer", "KidneyCancer", "LungCancer", "OvaryCancer", "ProstateCancer", "SkinCancer")){
  ...
  if(!dir.exists("OutputFiles/Plots_publication/plot_combinedEfficacySafety_topSignifFeatures/")){
    dir.create("OutputFiles/Plots_publication/plot_combinedEfficacySafety_topSignifFeatures/", recursive = TRUE)
  }

  tiff(paste0("OutputFiles/Plots_publication/plot_combinedEfficacySafety_topSignifFeatures/plot_combinedEfficacySafety_topSignifFeatures_", disease, ".tiff"), 
       width = 20,
       height = 7,
