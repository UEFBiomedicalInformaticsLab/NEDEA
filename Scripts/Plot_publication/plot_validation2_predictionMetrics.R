...
plot_data <- predict_metrics[predict_metrics$.metric %in% c("specificity", "accuracy"), ]


#Plot
tiff(paste0("OutputFiles/Plots_publication/Validation2_predictionMetrics_NES_combinedEfficacySafety_", drug_target_type, ".tiff"),
     width = 8,
     height = 4,
