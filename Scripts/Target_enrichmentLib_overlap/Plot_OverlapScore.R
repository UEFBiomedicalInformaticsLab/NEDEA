...
# Script to plot the overlap scores as box plot
...
# Read the data
overlap_data <- list()
overlap_data[["target_enrichLib"]] <- readRDS("OutputFiles/Geneset_overlap_check/OverlapScore_target_enrichLib.rds")
overlap_data[["target_extendedEnrichLib"]] <- readRDS("OutputFiles/Geneset_overlap_check/OverlapScore_target_extendedEnrichLib.rds")
overlap_data[["rankedGene_enrichLib"]] <- readRDS("OutputFiles/Geneset_overlap_check/OverlapScore_rankedGene_enrichLib.rds")
overlap_data[["rankedGene_extendedEnrichLib"]] <- readRDS("OutputFiles/Geneset_overlap_check/OverlapScore_rankedGene_extendedEnrichLib.rds")
...
tiff("OutputFiles/Geneset_overlap_check/OverlapScore_boxplot.tiff",
     width = 25, height = 30,
