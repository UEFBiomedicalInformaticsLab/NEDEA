...
# Script to plot the predicted probabilities on the validation data 3
...
for(disease in c("BreastCancer", "KidneyCancer", "LungCancer", "OvaryCancer", "ProstateCancer", "SkinCancer")){
  if(file.exists(paste0("OutputFiles/Validation_data_1/Predictions/predictions_NES_combinedEfficacySafety_", disease, "_", drug_target_type, ".csv"))){
    predict_result[[disease]] <- read.csv(file = paste0("OutputFiles/Validation_data_1/Predictions/predictions_NES_combinedEfficacySafety_", disease, "_", drug_target_type, ".csv"))
  }
}
...
tiff(paste0("OutputFiles/Plots_publication/Validation/Validation1_predictionProbabilities_NES_combinedEfficacySafety_", drug_target_type, ".tiff"),
     width = 10,
     height = 5,
