...
# Analysis of the significant features selected (proximity)
...
signif_feature <- read.csv(paste0("OutputFiles/Plots_publication/Proximity", proximity_type, "_", feature_type, "_boxplot_topSignifFeatures_EA/Proximity", proximity_type, "_", feature_type, "_WilcoxTest_rest.csv"))
...
write.csv(tmp1, "Trash/Significant_features_Proximity.csv", row.names = FALSE)
