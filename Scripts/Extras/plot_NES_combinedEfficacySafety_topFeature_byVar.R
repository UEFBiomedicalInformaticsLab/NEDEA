...
# Script to plot the NES of top (by variance) efficacy and safety features from FGSEA of combinedEfficacySafety library
...
tiff("OutputFiles/Plots/top_feature_NES_scatter/plot_NES_combinedEfficacySafety_topFeature_byVar.tiff",
     width = 30, height = 25,
