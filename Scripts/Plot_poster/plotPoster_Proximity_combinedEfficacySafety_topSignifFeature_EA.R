...
for(drug_target_type in c("known")){
  ...
  if(!dir.exists(paste0("OutputFiles/Plots_poster/Proximity", proximity_type, "_", feature_type, "_boxplot_topSignifFeatures_EA/"))){
    dir.create(paste0("OutputFiles/Plots_poster/Proximity", proximity_type, "_", feature_type, "_boxplot_topSignifFeatures_EA/"))
  }
  
  tiff(paste0("OutputFiles/Plots_poster/Proximity", proximity_type, "_", feature_type, "_boxplot_topSignifFeatures_EA/Proximity", proximity_type, "_", feature_type, "_boxplot_topSignifFeatures_EA_", drug_target_type, ".tiff"), 
       width = 35,
       height = 12,
