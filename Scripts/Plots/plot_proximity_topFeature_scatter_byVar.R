...
# Script to plot the proximity of top features (by variance)
...
if(!dir.exists("OutputFiles/Plots/top_feature_proximity_scatter/")){
  dir.create("OutputFiles/Plots/top_feature_proximity_scatter/", recursive = TRUE)
}


tiff(paste0("OutputFiles/Plots/top_feature_proximity_scatter/plot_proximity", proximity_type, "_", feature_type, "_topFeature_byVar.tiff"),
     width = 30, height = 25,
