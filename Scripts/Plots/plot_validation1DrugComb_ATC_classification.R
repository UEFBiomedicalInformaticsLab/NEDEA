...
if(!dir.exists("OutputFiles/Plots/ATC_classification/Validation_data_1/")){
  dir.create("OutputFiles/Plots/ATC_classification/Validation_data_1/", recursive = TRUE)
}
...
for(disease in c("BreastCancer", "KidneyCancer", "LungCancer", "OvaryCancer", "ProstateCancer", "SkinCancer")){
  ...
  tiff(paste0("OutputFiles/Plots/ATC_classification/Validation_data_1/drugCombs_ATCclass_", disease, ".tiff"),
       width = 10,
       height = 8,
