...
if(!dir.exists("OutputFiles/Plots/ATC_classification/Validation_data_3/")){
  dir.create("OutputFiles/Plots/ATC_classification/Validation_data_3/", recursive = TRUE)
}

for(disease in c("BreastCancer", "KidneyCancer", "LungCancer", "ProstateCancer", "SkinCancer")){
  ...
  tiff(paste0("OutputFiles/Plots/ATC_classification/Validation_data_3/drugCombs_ATCclass_", disease, ".tiff"),
       width = 10,
       height = 8,
