...
# Plot the NES as box plot
if(isTRUE(top9varying)){
  if(!dir.exists("OutputFiles/Plots/NES_boxPlot_top9Var/")){
    dir.create("OutputFiles/Plots/NES_boxPlot_top9Var/", recursive = TRUE)
  }
  tiff(paste0("OutputFiles/Plots/NES_boxPlot_top9Var/NES_", disease, "_", drug_target_type, "_", feature_type, "_", drugComb_category_type, ".tiff"),
       width = 30,
       height = 20,
...
if(isFALSE(top9varying)){
  if(!dir.exists("OutputFiles/Plots/NES_boxPlot_all/")){
