...
# Script to check the drug class in validation 2 dataset
...
if(!dir.exists("OutputFiles/Plots/ATC_classification/Validation_data_2/")){
  dir.create("OutputFiles/Plots/ATC_classification/Validation_data_2/", recursive = TRUE)
}
