...
db <- nodbi::src_sqlite(
  dbname = paste0("tmp_dir/6a_", disease, "_clinicalTrials_sql"),
  collection = disease
)
...
if(!dir.exists("InputFiles/Validation_data_6a/")){dir.create("InputFiles/Validation_data_6a/", recursive = TRUE)}
saveRDS(valid_drugCombs_cat, file = paste0("InputFiles/Validation_data_6a/drugCombs_validation6a_", disease, ".rds"))
