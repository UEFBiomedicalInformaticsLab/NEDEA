...
# Use the trained model to predict the labels on the validation data 7b
...
valid_drugCombs_cat <- readRDS(file = paste0("InputFiles/Validation_data_7b/drugCombs_validation7b_", disease, ".rds"))
...
fgsea_result <- readRDS(file = paste0("OutputFiles/Validation_data_7b/Features/fgseaNES_combinedEfficacySafety_", disease, "_", drug_target_type, ".rds"))
...
if(!dir.exists("OutputFiles/Validation_data_7b/Predictions/")){ dir.create("OutputFiles/Validation_data_7b/Predictions/", recursive = TRUE) }
write.csv(predict_result, file = paste0("OutputFiles/Validation_data_7b/Predictions/predictions_NES_combinedEfficacySafety_", disease, "_", drug_target_type, ".csv"), row.names = FALSE)
...
if(!dir.exists("OutputFiles/Validation_data_7b/Prediction_metrics/")){ dir.create("OutputFiles/Validation_data_7b/Prediction_metrics/", recursive = TRUE) }
write.csv(predict_metrics, file = paste0("OutputFiles/Validation_data_7b/Prediction_metrics/predictionMetrics_NES_combinedEfficacySafety_", disease, "_", drug_target_type, ".csv"), row.names = FALSE)
...
tiff(paste0("OutputFiles/Plots/Validation_data_heatmaps/plot_validation7b_heatmap_combinedEfficacySafety_", disease, "_", drug_target_type, ".tiff"),
     width = 25, height = 21,
