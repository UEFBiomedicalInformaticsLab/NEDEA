...
if(!dir.exists("InputFiles/Validation_data_7a/")){dir.create("InputFiles/Validation_data_7a/", recursive = TRUE)}
saveRDS(valid_drugCombs_cat, file = paste0("InputFiles/Validation_data_7a/drugCombs_validation7a_", disease, ".rds"))
