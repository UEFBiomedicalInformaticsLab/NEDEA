...
# Use the trained model to predict the labels on the validation data 6a
...
fgsea_result <- readRDS(file = paste0("OutputFiles/Validation_data_6a/Features/fgseaNES_combinedEfficacySafety_", disease, "_", drug_target_type, ".rds"))
...
if(!dir.exists("OutputFiles/Validation_data_6a/Predictions/")){ dir.create("OutputFiles/Validation_data_6a/Predictions/", recursive = TRUE) }
write.csv(predict_result, file = paste0("OutputFiles/Validation_data_6a/Predictions/predictions_NES_combinedEfficacySafety_", disease, "_", drug_target_type, ".csv"), row.names = FALSE)
...
if(!dir.exists("OutputFiles/Validation_data_6a/Prediction_metrics/")){ dir.create("OutputFiles/Validation_data_6a/Prediction_metrics/", recursive = TRUE) }
write.csv(predict_metrics, file = paste0("OutputFiles/Validation_data_6a/Prediction_metrics/predictionMetrics_NES_combinedEfficacySafety_", disease, "_", drug_target_type, ".csv"), row.names = FALSE)
...
tiff(paste0("OutputFiles/Plots/Validation_data_heatmaps/plot_validation6a_heatmap_combinedEfficacySafety_", disease, "_", drug_target_type, ".tiff"),
     width = 25, height = 21,
