...
# Generate the features for validation data 1b and check applicability domain
...
if(!dir.exists("OutputFiles/Validation_data_1b/Features/")){dir.create("OutputFiles/Validation_data_1b/Features/", recursive = TRUE)}
saveRDS(enrichment_result_mat, file = paste0("OutputFiles/Validation_data_1b/Features/fgseaNES_combinedEfficacySafety_", disease, "_", drug_target_type, ".rds"))
...
tiff(paste0("OutputFiles/Plots/validation_data_applicibility_domain/plot_validation1b_AD_combinedEfficacySafety_", disease, "_", drug_target_type, ".tiff"),
     width = 7, height = 6,
