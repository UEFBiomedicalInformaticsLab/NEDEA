...
db <- nodbi::src_sqlite(
  dbname = paste0("tmp_dir/6_", disease, "_clinicalTrials_sql"),
  collection = disease
)
...
if(!dir.exists("InputFiles/Validation_data_6/")){dir.create("InputFiles/Validation_data_6/", recursive = TRUE)}
saveRDS(valid_drugCombs_cat, file = paste0("InputFiles/Validation_data_6/drugCombs_validation6_", disease, ".rds"))
