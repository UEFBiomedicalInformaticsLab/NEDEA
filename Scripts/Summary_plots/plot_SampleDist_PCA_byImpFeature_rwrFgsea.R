...
# Save the plot
if(!dir.exists("OutputFiles/Plots/SampleDist_PCA_byImpFeature/")){
  dir.create("OutputFiles/Plots/SampleDist_PCA_byImpFeature/", recursive = TRUE)
}  
tiff(paste0("OutputFiles/Plots/SampleDist_PCA_byImpFeature/SampleDist_PCA_byImp_", feature_type, "_", model, "_", data_balance_method, ".tiff"),
     width = 20, height = 25,
