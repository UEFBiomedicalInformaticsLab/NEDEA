...
for(disease in c("LungCancer", "BreastCancer", "ProstateCancer", "OvaryCancer", "KidneyCancer", "SkinCancer")){
  ...
  pca_data_train <- pca_data_train[, keep]
  pca_data_ext <- pca_data_ext[, keep]
  ...
  if(!dir.exists("OutputFiles/Tables/Applicibility_domain/")){
    dir.create("OutputFiles/Tables/Applicibility_domain/", recursive = TRUE)
  }  
  write.csv(tmp2, paste0("OutputFiles/Tables/Applicibility_domain/ADcheck_NES_CombinedDisAdr2Gene_", disease, "__CDCDB_OrangeBook_rxotc.csv"), row.names = FALSE)
...
for(disease in c("LungCancer", "BreastCancer", "ProstateCancer", "OvaryCancer", "KidneyCancer", "SkinCancer")){
  ...
  write.csv(tmp2, paste0("OutputFiles/Tables/Applicibility_domain/ADcheck_NES_CombinedDisAdr2Gene_", disease, "__CCDCDB_AACT.csv"), row.names = FALSE)
...
for(disease in c("LungCancer", "BreastCancer", "ProstateCancer", "OvaryCancer", "KidneyCancer", "SkinCancer")){
  ...
  write.csv(tmp2, paste0("OutputFiles/Tables/Applicibility_domain/ADcheck_NES_CombinedDisAdr2Gene_", disease, "__CDD.csv"), row.names = FALSE)
