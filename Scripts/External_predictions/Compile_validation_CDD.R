...
# Script to compile results from external predictions using the CDD drug combinations
...
files <- list.files(path = "OutputFiles/External_predictions/CDD",
                    pattern = "^ExtPred_CDD_drugCombs__[a-zA-Z0-9_]+.xlsx", 
                    full.names = TRUE)
...
write.xlsx(extPred_drugCombs, "OutputFiles/External_predictions/CDD/Compiled_ExtPred_CDD_drugCombs.xlsx", 
