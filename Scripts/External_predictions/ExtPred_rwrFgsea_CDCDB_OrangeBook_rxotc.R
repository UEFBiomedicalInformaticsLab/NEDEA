...
# External predictions using the CDCDB drug combinations (RX/OTC type)
...
if(!dir.exists("OutputFiles/External_predictions/CDCDB/features/")){
  dir.create("OutputFiles/External_predictions/CDCDB/features/", recursive = TRUE)
}  
saveRDS(drugComb_NES, paste0("OutputFiles/External_predictions/CDCDB/features/CDCDB_OrangeBook_rxotc__", disease, "_", feature_type, ".rds"))
...
write.xlsx(predictions, paste0("OutputFiles/External_predictions/CDCDB/ExtPred_CDCDB_OrangeBook_rxotc__", disease, "_", model, "_", data_balance_method, "_", feature_type, ".xlsx"), 
