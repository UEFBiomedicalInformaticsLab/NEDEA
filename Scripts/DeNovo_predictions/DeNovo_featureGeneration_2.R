...
# Generate the features for de novo prediction data 2 and check applicability domain
...
# Save the results
if(!dir.exists("OutputFiles/DeNovo_data_2/Features/")){dir.create("OutputFiles/DeNovo_data_2/Features/", recursive = TRUE)}
saveRDS(enrichment_result_mat, file = paste0("OutputFiles/DeNovo_data_2/Features/fgseaNES_combinedEfficacySafety_", disease, "_", drug_target_type, ".rds"))
...
tiff(paste0("OutputFiles/Plots/DeNovo_data_applicibility_domain/plot_DeNovo_2_AD_combinedEfficacySafety_", disease, "_", drug_target_type, ".tiff"),
     width = 7, height = 6,
...
ggplot() +
  ...
  scale_color_manual(values = c("Eff" = "#77DD77", "Adv" = "#FF6961", "Unk" = "#808080")) + 
...
left_annot_color <- list(class_EffAdv = c("Eff" = "#77DD77", "Adv" = "#FF6961", "Unk" = "#808080"), 
