...
# Script to train predictive model (type 3)
...
tiff(paste0("OutputFiles/Predictive_model_3/metrics_PredictiveModel3_", disease, "_", drug_target_type, ".tiff"), 
     width = 20,
     height = 10,
...
final_model <- list("models" = model_list, "feature_threshold" = selected_threshold)

if(!dir.exists("OutputFiles/Predictive_model_3/")){ dir.create("OutputFiles/Predictive_model_3/") }
saveRDS(final_model, file = paste0("OutputFiles/Predictive_model_3/model_NES_combinedEfficacySafety_", disease, "_", drug_target_type, ".rds"))
