...
#     risk/severity indications that contain at least one drug involved
...
if(!dir.exists("InputFiles/DrugCombinations/DrugCombs_v2/")){
  dir.create("InputFiles/DrugCombinations/DrugCombs_v2/", recursive = TRUE)
} 
saveRDS(drugCombs, paste0("InputFiles/DrugCombinations/DrugCombs_v2//DrugComb_", disease, "_v2.rds"))
