...
OpenTargets_LiverCancer2Gene_SM_lib <- OpenTargets_Disease2Gene_SM_lib[grep("liver|hepato|hepatic", 
                                                                            names(OpenTargets_Disease2Gene_SM_lib), 
                                                                            ignore.case = TRUE)]
OpenTargets_LiverCancer2Gene_SM_lib <- OpenTargets_LiverCancer2Gene_SM_lib[grep("cancer|carcinoma|sarcoma|blastoma", 
                                                                                names(OpenTargets_LiverCancer2Gene_SM_lib), 
                                                                                ignore.case = TRUE)]
OpenTargets_LiverCancer2Gene_SM_lib <- OpenTargets_LiverCancer2Gene_SM_lib[grep("hereditary|familial|susceptibility|predisposition", 
                                                                                names(OpenTargets_LiverCancer2Gene_SM_lib), 
                                                                                ignore.case = TRUE, 
                                                                                invert = TRUE)] 
...
Enrichment_LiverCancer2Gene_lib <- c(DisGeNET_LiverCancer2Gene_lib, OpenTargets_LiverCancer2Gene_GA_lib, 
                                     ...
                                     OpenTargets_LiverCancer2Gene_SM_lib, 
