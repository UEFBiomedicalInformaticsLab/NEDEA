...
echo "Plot sample distribution by important features" $1 " - " $2, " ---------------------"

~/miniconda3/envs/interactome/bin/Rscript Scripts/Summary_plots/plot_SampleDist_byImpFeature_rwrFgsea.R --feature_type $1 --model $2 --data_balance_method none 