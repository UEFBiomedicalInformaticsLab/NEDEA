...
echo "Plot ExtData NES distribution" $1 " - " $2, " ---------------------"

~/miniconda3/envs/interactome/bin/Rscript Scripts/Summary_plots/plot_ExtPred_NES.R --disease $1 --data_balance_method $2 --feature_type $3