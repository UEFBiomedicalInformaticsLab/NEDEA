...
echo "Validation C-DCDB AATC ---------------------"

~/miniconda3/envs/interactome/bin/Rscript Scripts/External_predictions/ExtPred_rwrFgsea_CDCDB_AATC.R --disease $1 --data_balance_method $2 --model $3 --feature_type $4 --nproc 20