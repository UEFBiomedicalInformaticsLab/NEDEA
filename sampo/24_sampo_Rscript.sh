...
#SBATCH --time 0-12:00:00   # Runtime
...
echo "Validation C-DCDB Rx/OTC ---------------------"

~/miniconda3/envs/interactome/bin/Rscript Scripts/External_predictions/ExtPred_rwrFgsea_CDCDB_OrangeBook_rxotc.R --disease $1 --data_balance_method $2 --model $3 --feature_type $4 --nproc 20