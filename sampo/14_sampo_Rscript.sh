...
echo "ML BBSI Drug-Drug " $1 " - " $2 " ---------------------"

~/miniconda3/envs/interactome/bin/Rscript Scripts/Model_train/DrugCombs_trainML_BarabasiMetrics_DrugDrug.R --disease $1 --data_balance_method $2 --nproc 10