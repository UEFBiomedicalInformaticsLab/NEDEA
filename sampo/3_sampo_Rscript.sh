...
#SBATCH --mem=100G   # Reserve 100 GB RAM for the job
...
/opt/R/4.2.2/bin/Rscript Scripts/Feature_generation/Execute_FGSEA_EfficacySafety_on_drugCombs.R --disease $1 --drug_target_type $2 --nproc 30