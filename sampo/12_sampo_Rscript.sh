...
echo "ML BBSI Drug-ADR " $1 " - " $2 " ---------------------"

~/miniconda3/envs/interactome/bin/Rscript Scripts/Model_train/DrugCombs_trainML_BarabasiMetrics_DrugAdr.R --disease $1 --data_balance_method $2 --nproc 20