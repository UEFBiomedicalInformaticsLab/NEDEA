...
echo "Running FGSEA (pathways) for " $1 "- " $2 " ---------------------"

/opt/R/4.2.2/bin/Rscript Scripts/Feature_generation/Execute_FGSEA_Pathways_on_drugCombs.R --disease $1 --drug_target_type $2