...
# dNET RWR on Drug Combinations (version 3)
...
if(!dir.exists(paste0("Analysis/STRING/DrugCombs_v3/", disease, "/"))){
  dir.create(paste0("Analysis/STRING/DrugCombs_v3/", disease, "/"), recursive = TRUE)
} 

save(drugCombs_rwr_res_final, file = paste0("Analysis/STRING/DrugCombs_v3/", disease, "/dNetRWR050_", disease, "_DrugCombinations.rda"))
